...
# `output: "standalone"` does not include public/ — copy it so same-origin
# static assets ship (e.g. the vendored tesseract OCR worker/core/lang under
# public/tesseract/, generated by the build's vendor step).
